...
public class IncrementorViewModel extends ViewModel {
     ...
     * Add an observer to this live data.
     * This is a pass through method for
     * this classes MutableLiveData field of count. *
     * See LiveData.observe for more implementation details.
     * @param owner the LifecycleOwner which controls the observer
     * @param observer the observer that will receive the events
     */
    public void addCountObserver(@NonNull LifecycleOwner owner, @NonNull Observer<? super Integer> observer) {
        mCount.observe(owner, observer);
    }
    // You may want to consider pass through methods for all observe
    // and remove methods found in LiveData.
    /**
    ...
    public void increment() {
        mCount.setValue(mCount.getValue() + 5);
    }
}
