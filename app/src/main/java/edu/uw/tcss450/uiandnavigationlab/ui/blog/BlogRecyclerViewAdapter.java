...
public class BlogRecyclerViewAdapter extends RecyclerView.Adapter<BlogRecyclerViewAdapter.BlogViewHolder> {
    ...
    public BlogViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        return new BlogViewHolder(LayoutInflater.from(parent.
                getContext()).inflate(R.layout.fragment_blog_card, parent, false));
    ...
    /**
     * Objects from this class represent an
     * Individual row View from the List
    ...
    public class BlogViewHolder extends RecyclerView.ViewHolder {
        ...
        /**
         * When the button is clicked in the more state,
         * expand the card to display the blog preview
         * and switch the icon to the less state.
         * When the button is clicked in the less state,
         * shrink the card and switch the icon to the more state.
         *
        ...
        void setBlog(final BlogPost blog) {
            ...
            final String preview = Html.fromHtml(blog.getTeaser(),
                    Html.FROM_HTML_MODE_COMPACT).toString().substring(0, 100) + "...";
